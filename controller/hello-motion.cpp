/****************************************************************************
  ...
  This program uses the glutMotionFunc to support positionally moving
  a graphical object with the mouse.
...
std::string text = "Move grapic with mouse.";
...
int main(int argc, char* argv[])
{
  ...
  main_window = glutCreateWindow( "GLUI motion" );
  ...
  GLUI *glui = GLUI_Master.create_glui( "GLUI", 0, 400, 50 ); /* name, flags,
								 x, and y */
  new GLUI_StaticText( glui, "GLUI motion" );
