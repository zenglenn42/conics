//-----------------------------------------------------------------------------
// Code for interactively rendering a Bezier curve by specifying
// control points interactively.
//
// Courtesy:
// https://stackoverflow.com/questions/17556985/bezier-curve-using-c-opengl
//
// NB:
// Had to a namespace wrapper around Point to avoid collision with the
// point defined here:
...
//
// TODO: Isn't there a more gpu-friendly way that just takes the control points
//       directly?
//-----------------------------------------------------------------------------
...
void drawLine(my::Point p1, my::Point p2) {
    glBegin(GL_LINES);
...
my::Point drawBezier(my::Point PT[], double t) {
    my::Point P;
...
my::Point drawBezierGeneralized(my::Point PT[], double t) {
    my::Point P;
    P.x = 0; P.y = 0;   
...
void myMouse(int button, int state, int x, int y) {
  ...
  if(button == GLUT_LEFT_BUTTON && state == GLUT_DOWN) {
    ...
    if(points == clicks) 
    {
        ...
        {
            my::Point p2 = drawBezierGeneralized(abc,t);
            cout<<p1.x<<"  ,  "<<p1.y<<endl;
            cout<<p2.x<<"  ,  "<<p2.y<<endl;
            cout<<endl;
            drawLine(p1, p2);
