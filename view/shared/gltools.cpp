...
#else
    // Attempting to build examples under modern OS X.
    // https://stackoverflow.com/questions/3104478/how-to-find-an-fsref-from-a-directory-id-and-a-volume-number
    FSResolveNodeID(fwVersion, fwDir, &fRef);
#endif
